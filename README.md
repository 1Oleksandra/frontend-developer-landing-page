# 🚀 Frontend Developer Course Landing Page

A landing page for enrolling in the **Frontend Developer Course**, designed with modern animations, interactive features, and full responsiveness.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/1Oleksandra/frontend-developer-landing-page.git
📧 Contact
